...
## Objective
The objective of this lab is to analyze TLS (Transport Layer Security) traffic using Wireshark. By the end of this lab, I  will learn how TLS secures data over the network, understand handshake messages, and identify metadata like server names and certificate details.
