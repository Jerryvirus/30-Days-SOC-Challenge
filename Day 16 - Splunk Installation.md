...
## Objective  
The objective of this task is to understand how to install and configure Splunk on an Ubuntu machine. By completing this task, I will have Splunk up and running to collect and analyze security logs.
