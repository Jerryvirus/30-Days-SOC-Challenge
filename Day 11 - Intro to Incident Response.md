...
## Objective:
The objective of this lab is to introduce the core concepts of incident response, familiarize with the incident response lifecycle, and understand how basic threats on Windows systems are detected, analyzed, and responded to by SOC Analysts.
